...
[![Build](https://github.com/CUPUL-MIU-04/gradle-semantic-release-plugin/actions/workflows/build.yml/badge.svg)](https://github.com/CUPUL-MIU-04/gradle-semantic-release-plugin/actions/workflows/build.yml)
...
**Fork mantenido por:** CUPUL-MIU-04

**Compatibilidad:** semantic-release@25.0.2+
...
This fork is maintained to ensure compatibility with semantic-release@25.0.2 and later versions.

Copyright

Original Copyright (c) 2019-2024 Kengo TODA

Fork maintained by CUPUL-MIU-04
